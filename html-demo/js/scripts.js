(function ($) {
    ...
    if( $('#clock').length>0 ){
      ...
      Count Down
      -------------------------------------*/ 
    $( ".active-onhover .pbmit-miconheading-style-8:nth-child(2)" ).addClass('pbmit-mihbox-hover-active');
    $( ".active-onhover.pbmit-ihbox-style-1wrap .col-md-6:nth-child(2) .pbmit-ihbox-style-1" ).addClass('pbmit-mihbox-hover-active');
    
      $( ".active-onhover .pbmit-miconheading-style-8,.active-onhover .pbmit-ihbox-style-1" ).mouseover(function() {
        var main_row = $( this ).closest( '.active-onhover' );
        $('.pbmit-miconheading-style-8,.pbmit-ihbox-style-1', main_row).removeClass('pbmit-mihbox-hover-active'); 
        $(this).addClass('pbmit-mihbox-hover-active');
      }).mouseout(function() {
        var main_row = $( this ).closest( '.active-onhover' );
        $('.pbmit-miconheading-style-8,.pbmit-ihbox-style-1', main_row).removeClass('pbmit-mihbox-hover-active');
        $('.pbmit-miconheading-style-8:nth-child(2)', main_row).addClass('pbmit-mihbox-hover-active');
        $('.active-onhover.pbmit-ihbox-style-1wrap .col-md-6:nth-child(2) .pbmit-ihbox-style-1').addClass('pbmit-mihbox-hover-active');
      });
      /*-------------------------------------
        tooltip
